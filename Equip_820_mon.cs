...
namespace iS800
{
	...
	public partial class Equip_820_mon : Form
	{
		...
		private void Equip_202_mon_FormClosed(object sender, FormClosedEventArgs e)
		{
			...
			{
				Interaction.MsgBox("Anter de fechar a tela é necessário parar a monitoração!", MsgBoxStyle.OkOnly, null);
				return;
			}
		...
		private void dgv_Controle_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			checked
			{
				...
				{
				case 1:
					Interaction.MsgBox("Nesta configuração é permitido apenas a visualização do estado do controle!", MsgBoxStyle.OkOnly, null);
					break;
				case 2:
					if (!this.dgv_Controle.Rows[e.RowIndex].Cells[e.ColumnIndex].ReadOnly)
					{
						...
						{
							Interaction.MsgBox("AUTOMÁTICO -> MANUAL CONTROLE" + (e.RowIndex + 1).ToString(), MsgBoxStyle.OkOnly, null);
						...
						{
							Interaction.MsgBox("MANUAL -> AUTOMÁTICO CONTROLE" + (e.RowIndex + 1).ToString(), MsgBoxStyle.OkOnly, null);
							Mod_MD.Monitoracao_MD_RQ.Numero_motor = e.RowIndex + 1;
							Mod_MD.Monitoracao_MD_RQ.Comando = 70;
							Mod_MD.Monitoracao_MD_RQ.Controle_mon = 4;
						}
				...
				case 3:
					if (!this.dgv_Controle.Rows[e.RowIndex].Cells[e.ColumnIndex].ReadOnly)
					{
						...
						{
							Interaction.MsgBox("Comando Tirar de FALHA" + (e.RowIndex + 1).ToString(), MsgBoxStyle.OkOnly, null);
							Mod_MD.Monitoracao_MD_RQ.Numero_motor = e.RowIndex + 1;
							Mod_MD.Monitoracao_MD_RQ.Comando = 71;
							Mod_MD.Monitoracao_MD_RQ.Controle_mon = 4;
						}
						...
						{
							Interaction.MsgBox("Comando de Ligar CONTROLE" + (e.RowIndex + 1).ToString(), MsgBoxStyle.OkOnly, null);
							Mod_MD.Monitoracao_MD_RQ.Numero_motor = e.RowIndex + 1;
							Mod_MD.Monitoracao_MD_RQ.Comando = 67;
							Mod_MD.Monitoracao_MD_RQ.Controle_mon = 4;
						}
						...
						{
							Interaction.MsgBox("Comando de Desligar CONTROLE" + (e.RowIndex + 1).ToString(), MsgBoxStyle.OkOnly, null);
							Mod_MD.Monitoracao_MD_RQ.Numero_motor = e.RowIndex + 1;
							Mod_MD.Monitoracao_MD_RQ.Comando = 68;
							Mod_MD.Monitoracao_MD_RQ.Controle_mon = 4;
						}
		...
		private void bt_end_default_Click(object sender, EventArgs e)
		{
			if (Operators.CompareString(this.Comando_hab_monitoracao.Text, "Iniciar", false) != 0)
			{
				Interaction.MsgBox("Monitoração em execução. Não é possivel trocar os endereços", MsgBoxStyle.OkOnly, null);
			}
			else
			{
		...
		private void bt_rel_leitura_Click(object sender, EventArgs e)
		{
			...
			checked
			{
				while (i > 0)
				{
					...
					{
					case 0:
						this.Mensagem_MD202_mon("Leitura Relógio - Ok", (int)OpenMode.Binary);
						this.Calcula_Estatistica_820_300(1);
					...
					case 2:
						if (i == 0)
						{
							this.Mensagem_MD202_mon("Erro Leitura Relógio - ChkSum", (int)OpenMode.Input);
							this.Calcula_Estatistica_820_300(3);
						}
						else
						{
					...
					case 3:
						if (i == 0)
						{
							this.Mensagem_MD202_mon("Erro Leitura Relógio - Timeout", (int)OpenMode.Input);
							this.Calcula_Estatistica_820_300(3);
						}
						else
						{
					...
					if (i == 0)
					{
						this.Mensagem_MD202_mon("Erro Leitura Relógio - não determinado", (int)OpenMode.Input);
						this.Calcula_Estatistica_820_300(3);
						goto IL_100;
					}
					this.Calcula_Estatistica_820_300(2);
		...
		private void bt_rel_escrita_Click(object sender, EventArgs e)
		{
			...
			checked
			{
				while (i > 0)
				{
					...
					{
					case 0:
						this.Mensagem_MD202_mon("Escrita Relógio - Ok", (int)OpenMode.Binary);
						this.Calcula_Estatistica_820_300(1);
						return;
					case 1:
						goto IL_144;
					case 2:
						if (i == 0)
						{
							this.Mensagem_MD202_mon("Erro Escrita Relógio - ChkSum", (int)OpenMode.Input);
							this.Calcula_Estatistica_820_300(3);
						}
						else
						{
					...
					case 3:
						if (i == 0)
						{
							this.Mensagem_MD202_mon("Erro Escrita Relógio - Timeout", (int)OpenMode.Input);
							this.Calcula_Estatistica_820_300(3);
						}
						else
						{
					...
					if (i == 0)
					{
						this.Mensagem_MD202_mon("Erro Escrita Relógio - não determinado", (int)OpenMode.Input);
						this.Calcula_Estatistica_820_300(3);
						goto IL_164;
					}
					this.Calcula_Estatistica_820_300(2);
