...
namespace iS800
{
	...
	public partial class RT_810_conf : Form
	{
		...
		private void InicializaEstrutura_DataGridView_EA_RT_810()
		{
			...
			RT_geral.RT_810_DataGrigViewEAColunas[0].AlingColuna = (System.Windows.Forms.DataGridViewContentAlignment)64;
			RT_geral.RT_810_DataGrigViewEAColunas[1].AlingColuna = (System.Windows.Forms.DataGridViewContentAlignment)64;
			RT_geral.RT_810_DataGrigViewEAColunas[2].AlingColuna = (System.Windows.Forms.DataGridViewContentAlignment)64;
		...
		private void GeraDataGridView_Setpoints_RT_810()
		{
			...
			this.DataGridView_setpoints_810.DefaultCellStyle.Alignment = (System.Windows.Forms.DataGridViewContentAlignment)64;
			int num = 0;
			checked
			{
				do
		...
		private void GeraDataGridView_ED_RT_810()
		{
			...
			this.DataGridView_RT810_ED.DefaultCellStyle.Alignment = (System.Windows.Forms.DataGridViewContentAlignment)64;
			int num = 0;
			checked
			{
				do
		...
		{
			RT_geral.RT_810_BD.Modo_de_operacao.Indice = 0;
			RT_geral.RT_810_BD.Modo_de_operacao.Valor = RT_geral.RT_810_BD.Modo_de_operacao.valores[RT_geral.RT_810_BD.Modo_de_operacao.Indice];
		...
		private void ComboBox_modo_repeticao_RT_810_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				RT_geral.RT_810_BD.Hab_repetidora.Valor = Conversions.ToInteger(Operators.AddObject(null, 21856));
		...
		{
			RT_geral.RT_810_BD.Modelo.Indice = 0;
			RT_geral.RT_810_BD.Modelo.Valor = RT_geral.RT_810_BD.Modelo.valores[RT_geral.RT_810_BD.Modelo.Indice];
			this.Habilita_Funcoes_de_Tela_RT_810(Conversions.ToInteger(null));
		}
		...
		{
			RT_geral.RT_810_BD.Intervalo_tx_pto_pto.Valor = 0;
		...
		{
			RT_geral.RT_810_BD.Tempo_ptt.Valor = Conversions.ToInteger(Operators.MultiplyObject(Operators.IntDivideObject(((NumericUpDown)sender).Value, 10), 10));
						NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_810_BD.End_mestre.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_810_BD.End_estacao.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_810_BD.AD_Intervalo.Valor = Conversions.ToInteger(Operators.MultiplyObject(Operators.IntDivideObject(((NumericUpDown)sender).Value, 10), 10));
						NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_810_BD.AD_Tamanho_filtro.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_810_BD.End_repetidora.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_810_BD.Num_repetidoras.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		private void DataGridView_setpoints_810_CurrentCellDirtyStateChanged(object sender, EventArgs e)
		{
			...
			{
				this.DataGridView_setpoints_810.CommitEdit((System.Windows.Forms.DataGridViewDataErrorContexts)512);
			}
		}
		...
		private void DataGridView_processo_810_P1_CurrentCellDirtyStateChanged(object sender, EventArgs e)
		{
			...
			{
				this.DataGridView_processo_810_P1.CommitEdit((System.Windows.Forms.DataGridViewDataErrorContexts)512);
			}
		}
		...
		private void DataGridView_parametros_EA_810_CurrentCellDirtyStateChanged(object sender, EventArgs e)
		{
			...
			{
				this.DataGridView_parametros_EA_810.CommitEdit((System.Windows.Forms.DataGridViewDataErrorContexts)512);
			}
		}
