			...
			checked
			{
				...
				else if (pag == 2048)
				{
					...
					if (!perifericos.Lista_ValorPermitido(RT_geral.RT_821_BD.baudrate_com1.Valor, perifericos.ListaBaudRate))
					{
						...
						Interaction.MsgBox("É possível qua a sua placa RT821_300 não dê suporte a configuração da porta COM1. Será utilizado um valor padrão.", (MsgBoxStyle)48, null);
					}
					if (!perifericos.Lista_ValorPermitido(RT_geral.RT_821_BD.baudrate_com2.Valor, perifericos.ListaBaudRate))
					{
						...
						Interaction.MsgBox("É possível qua a sua placa RT821_300 não dê suporte a configuração da porta COM2. Será utilizado um valor padrão.", (MsgBoxStyle)48, null);
					}
