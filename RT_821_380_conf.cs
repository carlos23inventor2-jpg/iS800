...
namespace iS800
{
	...
	[DesignerGenerated]
	public class RT_821_380_conf : Form
	{
		// Token: 0x060018F9 RID: 6393 RVA: 0x003AFBFC File Offset: 0x003ADFFC
		public RT_821_380_conf()
		{
			base.Activated += new EventHandler(this.RT_821_380_Conf_Activated);
			base.FormClosed += new FormClosedEventHandler(this.RT_821_380_Conf_FormClosed);
			base.Load += new EventHandler(this.RT_821_380_Conf_Load);
		...
		private void RT_821_380_Conf_Load(object sender, EventArgs e)
		{
			...
			checked
			{
				...
				this.TabPage_Display.BackColor = Color.FromKnownColor((KnownColor)8);
				this.TabPage_Display.ForeColor = Color.FromKnownColor((KnownColor)10);
				this.TabPage_DadosInstalacao.BackColor = Color.FromKnownColor((KnownColor)8);
				this.TabPage_DadosInstalacao.ForeColor = Color.FromKnownColor((KnownColor)10);
				// ── Novas abas: Vazão & Calhas e Periféricos ────────────────────
				// Inseridas ANTES de DadosInstalacao (index 7 = após Display, index 8 = após VasosCalhas)
				this.TabPage_VasosCalhas = this.CriaTabVasosCalhas();
				this.TabControl_821.TabPages.Insert(7, this.TabPage_VasosCalhas);
				this.TabPage_VasosCalhas.BackColor = Color.FromKnownColor((KnownColor)8);
				this.TabPage_VasosCalhas.ForeColor = Color.FromKnownColor((KnownColor)10);
				this.TabPage_Perifericos = this.CriaTabPerifericos();
				this.TabControl_821.TabPages.Insert(8, this.TabPage_Perifericos);
				this.TabPage_Perifericos.BackColor = Color.FromKnownColor((KnownColor)8);
				this.TabPage_Perifericos.ForeColor = Color.FromKnownColor((KnownColor)10);
				...
				this.ToolStripLabel1.Text = "RT821/380";
			}
		}

		// Token: 0x060019F8 RID: 6648 RVA: 0x003B7030 File Offset: 0x003B5430
		private void RT_821_380_Conf_Activated(object sender, EventArgs e)
		{
			Geral.Equipamento_selecionado = 821;
			Geral.Equipamento_versao = 3;
			Geral.Equipamento_build = 80;
		}
		...
		{
			RT_geral.RT_821_BD.End_repetidora.Valor = 0;
		...
		{
			RT_geral.RT_821_BD.Num_repetidoras.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_821_BD.Modelo.Indice = 0;
			RT_geral.RT_821_BD.Modelo.Valor = RT_geral.RT_821_BD.Modelo.valores[RT_geral.RT_821_BD.Modelo.Indice];
			this.Habilita_Funcoes_de_Tela_RT_821(Conversions.ToInteger(null));
		}
		...
		{
			RT_geral.RT_821_BD.End_mestre.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_821_BD.End_estacao.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_821_BD.Tempo_ptt.Valor = Conversions.ToInteger(Operators.MultiplyObject(Operators.IntDivideObject(((NumericUpDown)sender).Value, 10), 10));
						NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_821_BD.AD_Intervalo.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_821_BD.AD_Tamanho_filtro.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		private void DataGridView_visor_RT_821_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
		{
			...
			{
				RT_geral.RT_821_BD.dsp_nome[e.RowIndex].Valor = Conversions.ToString(RuntimeHelpers.GetObjectValue(e.FormattedValue)).ToUpper();
				DataGridView dataGridView = (DataGridView)sender;
		...
		private void ToolStripButton_RT821_Abrir_Click(object sender, EventArgs e)
		{
			checked
			{
				...
				try
				{
					...
					if (this.OpenFileDialog_RT821.ShowDialog() == DialogResult.OK)
					{
		...
		private void ToolStripButton_RT821_Salvar_Click(object sender, EventArgs e)
		{
			checked
			{
				...
				try
				{
					...
					if (this.SaveFileDialog_RT821.ShowDialog() == DialogResult.OK)
					{
		...
		private void RT_821_380_Conf_FormClosed(object sender, FormClosedEventArgs e)
		{
		...
		private void cb_modorepetidora_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			RT_geral.RT_821_BD.modo_repetidora.Valor = RT_geral.RT_821_BD.modo_repetidora.valores[Conversions.ToInteger(null)];
			RT_geral.RT_821_BD.modo_repetidora.Indice = 0;
		}
		...
		{
			RT_geral.RT_821_BD.modo_operacao.Indice = 0;
		...
		{
			RT_geral.RT_821_BD.intervalo_tx.Valor = 0;
			NumericUpDown numericUpDown = (NumericUpDown)sender;
		...
		{
			RT_geral.RT_821_BD.baudrate_com1.Indice = 0;
			RT_geral.RT_821_BD.baudrate_com1.AtualizaValorPeloIndice();
		}
		...
		{
			RT_geral.RT_821_BD.baudrate_com2.Indice = 0;
			RT_geral.RT_821_BD.baudrate_com2.AtualizaValorPeloIndice();
		}
