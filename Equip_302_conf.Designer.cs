namespace iS800
{
	...
	public partial class Equip_302_conf : global::System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Valor_intervalo_polling.TextAlign = 2;
			...
			this.Valor_erro_falha.TextAlign = 2;
			...
			this.Valor_timeout.TextAlign = 2;
			...
			this.Valor_endereco.TextAlign = 2;
			...
			this.Valor_num_tentativas.TextAlign = 2;
			...
			this.DataGridView1.BorderStyle = 0;
			this.DataGridView1.CellBorderStyle = 3;
			...
			this.DataGridView_RQ.BorderStyle = 0;
			this.DataGridView_RQ.CellBorderStyle = 3;
			...
			this.DataGridView_central_rq.BorderStyle = 0;
			this.DataGridView_central_rq.CellBorderStyle = 3;
			...
			this.DataGridView_central_res.BorderStyle = 0;
			this.DataGridView_central_res.CellBorderStyle = 3;
			...
			this.DataGridView_central_geral.BorderStyle = 0;
			this.DataGridView_central_geral.CellBorderStyle = 3;
			...
			this.Valor_vista_equipamentos.TextAlign = 2;
			...
			this.Valor_end_ini_vista.TextAlign = 2;
			...
			this.Valor_end_ini_rq.TextAlign = 2;
			...
			this.Valor_end_ini_res.TextAlign = 2;
			...
			this.Valor_rq_equipamentos.TextAlign = 2;
			...
			this.Valor_res_equipamentos.TextAlign = 2;
			...
			this.Valor_res_sistema.TextAlign = 2;
