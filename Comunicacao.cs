		...
		public static bool Init_porta_serial()
		{
			...
			try
			{
				...
				if (Comunicacao.Config_sistema.tipo_interface == 1)
				{
					...
					MyProject.Forms.Plataforma.SerialPort1.Parity = (System.IO.Ports.Parity)(int)Comunicacao.Config_sistema.Serial.Parity;
					MyProject.Forms.Plataforma.SerialPort1.StopBits = (System.IO.Ports.StopBits)(int)Comunicacao.Config_sistema.Serial.StopBits;
